package paneles.ExtraDLineasTelefonicas;
...
public class Disponibilidad extends javax.swing.JFrame {
    ...
    public Disponibilidad() {
        ...
        val.NegarPegado(txtDisponibiidad);
        //------------------------------------------------------------------------------
    }
    ...
    private void CargarTabla() {
        ...
        CrearTabla.CargarTabla(tblCentro, "SELECT Disponible from [VistaDisponibilidades]");
    }
    ...
    private void initComponents() {
        ...
        txtDisponibiidad = new javax.swing.JTextField();
        ...
        setTitle("Disponibilidad-Linea Telefonica");
        setResizable(false);
        setType(java.awt.Window.Type.POPUP);

        lblPlanilla.setForeground(new java.awt.Color(0, 0, 0));
        lblPlanilla.setText("Disponibilidad de la linea:");

        txtDisponibiidad.setPreferredSize(new java.awt.Dimension(65, 26));
        txtDisponibiidad.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                txtDisponibiidadKeyTyped(evt);
            }
        });
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addComponent(txtDisponibiidad, javax.swing.GroupLayout.PREFERRED_SIZE, 192, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(lblPlanilla)
                    .addComponent(txtDisponibiidad, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void tblCentroMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblCentroMouseClicked
        ...
        if (classcrud.CargarDatoClick(tblCentro, "SELECT [ID],[Disponible] from VistaDisponibilidades where Disponible=?", "Disponible", "ID", txtDisponibiidad, txtID)) {
    ...
    private void btnModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModificarActionPerformed
        ...
        AccionesCrud classcrud = new AccionesCrud();
        if (classcrud.Validar(txtDisponibiidad, "La Disponibilidad de la linea")) {
            if (classcrud.Modificar(txtDisponibiidad, txtID, "exec UpdateDisponibilidad ?,?")) {
                CargarTabla();
                Limpiar();
            }
        }
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        ...
        AccionesCrud classcrud = new AccionesCrud();
        if (classcrud.Validar(txtDisponibiidad, "La Disponibilidad de la linea")) {
            if (classcrud.Eliminar(txtID, "exec EliminarDisponibilidad ?")) {
                CargarTabla();
                Limpiar();
            }
        }
    ...
    private javax.swing.JTextField txtDisponibiidad;
