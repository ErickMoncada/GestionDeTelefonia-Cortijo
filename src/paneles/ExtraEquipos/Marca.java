...
public class Marca extends javax.swing.JFrame {
    ...
    private void tblCentroMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblCentroMouseClicked
        ...
        if (classcrud.CargarDatoClick(tblCentro, "SELECT [ID],[Marca] from VistaMarcaEquipos where Marca=?", "Marca", "ID", txtMarca, txtID)) {
    ...
    private void btnModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModificarActionPerformed
        ...
        AccionesCrud classcrud = new AccionesCrud();
        if (classcrud.Validar(txtMarca, "La Marca del equipo")) {
            if (classcrud.Modificar(txtMarca, txtID, "exec UpdateMarcaEquipo ?,?")) {
                CargarTabla();
                Limpiar();
            }
        }
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        ...
        AccionesCrud classcrud = new AccionesCrud();
        if (classcrud.Validar(txtMarca, "La Marca del equipo")) {
            if (classcrud.Eliminar(txtID, "exec EliminarMarca ?")) {
                CargarTabla();
                Limpiar();
            }
        }
